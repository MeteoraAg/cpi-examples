...
async fn test_dlmm_initialize_position() {
    ...
    let accounts = cpi_example::accounts::InitializePosition {
    ...
    let ix_data = cpi_example::instruction::InitializePosition {
        lower_bin_id,
        width,
    }
    .data();
...
async fn test_dlmm_initialize_position_with_pda_creator() {
    ...
    let accounts = cpi_example::accounts::InitializePositionWithPdaOwner {
        position: position_keypair.pubkey(),
        lb_pair: lb_pair_address,
        authority,
        system_program: system_program::ID,
    ...
    let ix_data = cpi_example::instruction::InitializePositionWithPdaOwner {
        lower_bin_id,
        width,
    }
    .data();
...
async fn test_dlmm_initialize_pda_position_with_pda_creator() {
    ...
    let accounts = cpi_example::accounts::InitializePdaPositionWithPdaOwner {
        position,
        lb_pair: lb_pair_address,
        authority,
        system_program: system_program::ID,
    ...
    let ix_data = cpi_example::instruction::InitializePdaPositionWithPdaOwner {
        index,
        lower_bin_id,
        width,
    }
